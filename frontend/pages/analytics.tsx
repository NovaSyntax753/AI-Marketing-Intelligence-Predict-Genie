...
const CustomTooltip = ({
  ...
  return (
    ...
    >
      <div style={{ marginBottom: "4px", color: "#94a3b8", fontSize: "11px" }}>
        {label}
      </div>
      ...
      <Layout title="Analytics">
        <div className="empty-state">
          ...
          <div className="empty-state-desc">
            Upload a marketing dataset to unlock charts and insights.
          </div>
                ...
                <tbody>
                  {analytics.top_performing_posts
                    ...
                    .map((post: any, i: number) => (
                      <tr key={i}>
                        <td style={{ fontWeight: 600, color: "#6c3bfe" }}>
                          {i + 1}
                        </td>
                        <td>
                          <span className={`pill pill-${post.post_type}`}>
                            {post.post_type}
                          </span>
                        </td>
